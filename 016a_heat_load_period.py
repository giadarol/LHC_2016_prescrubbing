...
for i_fill, filln in enumerate(fill_list):
    ...
    if flag_filln and t_startfill>t_start_unix-15*60:
        ...
        ax1.axvline(fds, c='grey', ls='dashed', lw=2, alpha=0.8)
        ax2.axvline(fds, c='grey', ls='dashed', lw=2, alpha=0.8)
        ax3.axvline(fds, c='grey', ls='dashed', lw=2, alpha=0.8)
...
fig.suptitle('From ' + tref_string)
pl.savefig('test.png', dpi=200)
pl.show()
